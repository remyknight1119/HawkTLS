...
static TLS_CIPHER tls1_2_ciphers[] = {
    {
        .cp_name = TLS1_TXT_DHE_RSA_WITH_AES_128_SHA256,
        .cp_id = TLS1_CK_DHE_RSA_WITH_AES_128_SHA256,
        .cp_algorithm_mkey = TLS_kDHE,
        .cp_lgorithm_auth = TLS_aRSA,
        .cp_algorithm_enc = TLS_AES128,
        .cp_algorithm_mac = TLS_SHA256,
        .cp_alg_bits = 128,
        .cp_strength_bits = 128,
    },
    {
        .cp_name = TLS1_TXT_DHE_RSA_WITH_AES_256_SHA256,
        .cp_id = TLS1_CK_DHE_RSA_WITH_AES_256_SHA256,
        .cp_algorithm_mkey = TLS_kDHE,
        .cp_lgorithm_auth = TLS_aRSA,
        .cp_algorithm_enc = TLS_AES256,
        .cp_algorithm_mac = TLS_SHA256,
        .cp_alg_bits = 256,
    ...
    {
        .cp_name = TLS1_TXT_ECDHE_ECDSA_WITH_AES_128_SHA256,
        .cp_id = TLS1_CK_ECDHE_ECDSA_WITH_AES_128_SHA256,
        .cp_algorithm_mkey = TLS_kECDHE,
        .cp_lgorithm_auth = TLS_aECDSA,
        .cp_algorithm_enc = TLS_AES128,
        .cp_algorithm_mac = TLS_SHA256,
    ...
    {
        .cp_name = TLS1_TXT_ECDHE_ECDSA_WITH_AES_256_SHA384,
        .cp_id = TLS1_CK_ECDHE_ECDSA_WITH_AES_256_SHA384,
        .cp_algorithm_mkey = TLS_kECDHE,
        .cp_lgorithm_auth = TLS_aECDSA,
        .cp_algorithm_enc = TLS_AES256,
        .cp_algorithm_mac = TLS_SHA384,
        .cp_alg_bits = 256,
        .cp_strength_bits = 256,
    },
    {
        .cp_name = TLS1_TXT_ECDHE_RSA_WITH_AES_128_SHA256,
        .cp_id = TLS1_CK_ECDHE_RSA_WITH_AES_128_SHA256,
        .cp_algorithm_mkey = TLS_kECDHE,
        .cp_lgorithm_auth = TLS_aRSA,
        .cp_algorithm_enc = TLS_AES128,
        .cp_algorithm_mac = TLS_SHA256,
    ...
    {
        .cp_name = TLS1_TXT_ECDHE_RSA_WITH_AES_256_SHA384,
        .cp_id = TLS1_CK_ECDHE_RSA_WITH_AES_256_SHA384,
        .cp_algorithm_mkey = TLS_kECDHE,
        .cp_lgorithm_auth = TLS_aRSA,
        .cp_algorithm_enc = TLS_AES256,
        .cp_algorithm_mac = TLS_SHA384,
